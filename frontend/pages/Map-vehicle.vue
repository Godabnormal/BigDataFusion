...
import SearchBoxMap from "../components/Searchbox-map-vehicle.vue";
...
export default {
  ...
  methods: {
    getMarker() {
      this.$axios
        .$post("http://datascience.mfu.ac.th/dfapi/getmapmarker/vehicle")
        .then((res) => {
          this.loaded = true
          ...
          this.location = res.mapvehicledata.map((item) => ({
