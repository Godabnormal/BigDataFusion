      ...
      <div class="chart-container">
        <div class="chart-container-top">
          <b-row class="justify-content-md-center">
            <div class="chart1">
              <h5 style="text-align: center">จำนวนวัตถุแบ่งตามประเภทวัตถุ</h5>
            ...
            <div class="chart2">
              <h5 style="text-align: center">จำนวนวัตถุแบ่งตามช่วงเวลา</h5>
            ...
            <div class="chart3">
              <h5 style="text-align: center">จำนวนวัตถุแบ่งตามสถานะ</h5>
        ...
        <div class="chart-container-bottom">
          <div class="chart4">
            <h5 style="text-align: center">จำนวนวัตถุแบ่งตามสถานที่</h5>
...
import SearchBoxChart from "../components/ChartObjectSearch.vue";
        ...
        tooltips: {
          ...
          callbacks: {
            label: function (tooltipItem, data) {
              ...
              return (
                data.labels[tooltipItem.index] + " : " + currentValue + " ชิ้น"
              );
            },
          },
        },
