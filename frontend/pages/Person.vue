      ...
      <div class="chart-container">
        <div class="chart-container-top">
          <b-row class="justify-content-md-center">
            <div class="chart1">
              <h5 style="text-align: center">จำนวนบุคคลแบ่งตามหน่วยงาน</h5>
            ...
            <div class="chart2">
              <h5 style="text-align: center">จำนวนบุคคลแบ่งตามช่วงเวลา</h5>
            ...
            <div class="chart3">
              <h5 style="text-align: center">จำนวนบุคคลแบ่งตามสถานะ</h5>
        ...
        <div class="chart-container-bottom">
          <div class="chart4">
            <h5 style="text-align: center">จำนวนบุคคลแบ่งตามสถานที่</h5>
...
import SearchBoxChart from "../components/ChartPersonSearch.vue";
...
export default {
        ...
        tooltips: {
          ...
          callbacks: {
            label: (tooltipItems, data) => {
              return tooltipItems.xLabel + " : " + tooltipItems.yLabel + " คน";
            },
          },
        },
        responsive: true,
  ...
  methods: {
    getChartData() {
      this.$axios
        .$post("http://datascience.mfu.ac.th/dfapi/getchartdata/person")
        .then((res) => {
          this.counts_1 = res.chartdata_company.map((item) => item.sum_person);
          this.labels_1 = res.chartdata_company.map((item) => item.company);
          this.loaded1 = true;

          this.counts_2 = res.chartdata_time.map((item) => item.sum_person);
          this.labels_2 = res.chartdata_time.map((item) => item.time);
          this.loaded2 = true;

          this.counts_3 = res.chartdata_status.map((item) => item.sum_person);
          this.labels_3 = res.chartdata_status.map((item) => item.status);
          this.loaded3 = true;

          this.counts_4 = res.chartdata_location.map((item) => item.sum_person);
